...
class AboutClassMethods < Neo::Koan
  ...
  #   self - it seems more clear which methods are class vs instance
  # Are there times you might prefer one over the other?
  #   maybe a class << self block might make more sense in a class that had very few instance methods
