...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # allows you to iterate over the contents of an array and perform operations 
    # on the current item using the starting value and the return from the block
  end
  ...
  #   # code to read 'file'
  # 
  # Because the file variable will only be in the block (lexical) scope?
  #
